    ...
    <section class="display-choice-panel faq-panel popup-motion-panel" id="faqPanel" tabindex="-1">
      ...
      <div class="faq-sections">
        ...
        <section class="faq-section">
          ...
          <details><summary>What is the Windows 11 Template?</summary><p>It is a prepared Windows 11 virtual disk for the public Hyper-V runtime. Selecting it creates a temporary child disk for the current session, avoiding a complete Windows installation while preventing visitor disks from accumulating on the host.</p></details>
          ...
          <details><summary>Can I save my virtual machine?</summary><p>Browser-local runtimes may support saved state, but public Hyper-V sessions are temporary. The Windows 11 Template disk is deleted when the session ends, so export anything important before leaving.</p></details>
          <details><summary>What does Request new disk do?</summary><p>It discards the current temporary Hyper-V child disk and prepares a clean replacement from the template. Files and changes on the previous disk cannot be recovered afterward.</p></details>
        ...
        <section class="faq-section">
          ...
          <details><summary>Are my files private?</summary><p>The active Hyper-V session is tied to its requesting browser identity, and the host blocks other visitors from requesting its screen, controls, credentials, or session ID. Its temporary disk is deleted when the session ends. Even with those protections, do not upload highly sensitive data to a public host.</p></details>
          ...
          <details><summary>Are private Windows disks stored forever?</summary><p>No. The host keeps only the active session's temporary differencing disk and deletes it when that session ends.</p></details>
          <details><summary>What happens when my temporary disk is deleted?</summary><p>The next Windows 11 Template launch creates a clean differencing disk from the read-only base template. Files and settings from the previous session do not return.</p></details>
        </section>
