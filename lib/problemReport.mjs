...
export const buildProfanityModerationEmail = () => ({
  ...
  text: [
    ...
    "",
    "Your reporting privileges have been suspended for 20 minutes.",
    "",
        ...
        <div style="padding:32px 14px">
          <div style="max-width:680px;margin:0 auto;border:1px solid #24647a;border-top:4px solid #ff4d57;background:#0d1620">
            ...
            <main style="padding:24px;color:#dcecf5;font-size:15px;line-height:1.65">
              ...
              <p style="padding:12px;border-left:3px solid #ff4d57;background:#221317;color:#ff9ba1"><strong>Your reporting privileges have been suspended for 20 minutes.</strong></p>
